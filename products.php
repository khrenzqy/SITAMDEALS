...
<body class="bg-cream text-forest">
  ...
  <nav class="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-[6%] h-[72px] bg-forest/95 backdrop-blur-md border-b border-leaf/10">
    ...
    <ul class="flex items-center gap-8 list-none">
      <li><a href="index.php" class="text-cream/75 hover:text-gold text-sm font-medium tracking-widest uppercase">Home</a></li>
      <li><a href="products.php" class="text-gold text-sm font-medium tracking-widest uppercase border-b-2 border-gold">Produk</a></li>
      <li class="relative">
