...
<body class="bg-cream text-forest overflow-x-hidden">
  ...
  <section class="py-24 px-[6%] bg-[#f0f4ee]" id="produk">
    <div class="flex justify-between items-end mb-12 max-w-5xl mx-auto">
      ...
      <a href=""
        class="text-sage text-sm font-semibold border-b border-sage pb-0.5 hover:text-forest transition-colors">Lihat
        Semua →</a>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
      ...
      <div class="bg-white rounded-2xl overflow-hidden hover:-translate-y-2 hover:shadow-2xl transition-all">
        <div class="h-48 flex items-center justify-center text-6xl relative"
          style="background:linear-gradient(135deg,#b8d9c5,#72b88a)">
          🥛 <span
            class="absolute top-3.5 left-3.5 bg-gold text-forest text-xs font-bold px-2.5 py-1 rounded-full">TERLARIS</span>
        </div>
        <div class="p-5">
          ...
          <div class="flex items-center justify-between">
            <span class="font-playfair text-xl font-bold text-sage">Rp 18.500</span>
            <button
              class="w-8 h-8 bg-forest text-white rounded-full text-lg hover:bg-gold hover:text-forest transition-colors flex items-center justify-center">+</button>
          </div>
        </div>
      </div>
  </section>
